...
<body>
	...
	<section id="sidebar">
		<a href="#" class="brand">
			...
			<span class="text">Truszed Agent</span>
		</a>
		<ul class="side-menu top">
			...
			<li>
				<a href="make_property.php">
					<i class='bx bxs-shopping-bag-alt' ></i>
					<span class="text">Make Post</span>
				</a>
			</li>
			<li>
				<a href="#">
		...
		<main>
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
						<p><strong></strong> <?php echo htmlspecialchars($row['full_name']); ?></p>
						</li>
					</ul>
				</div>
			...
			<ul class="box-info">
				...
				<i class='bx bx-user'></i> 
					<span class="text">
						<h3>            <p><strong></strong> <?php echo htmlspecialchars($row['id']); ?></p></h3>
						<p>Agent Id</p>
					</span>
				</li>
				<li>
