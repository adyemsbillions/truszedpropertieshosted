...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !$error_message) {
    ...
    if (empty($error_message)) {
        // Insert the form data into the database, including the admin_id
        $sql = "INSERT INTO agent_properties 
            (property_name, price, address, dimensions, property_type, bedrooms, bathrooms, toilets, parking_space, post_image, other_images, market_status, state, lga, property_details, admin_id)
            VALUES ('$property_name', '$price', '$address', '$dimensions', '$property_type', '$bedrooms', '$bathrooms', '$toilets', '$parking_space', '$post_image', '$other_images_str', '$market_status', '$state', '$lga', '$property_details', '$admin_id')";
