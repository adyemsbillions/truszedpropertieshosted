...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="truszedlogo.png"/>
...
<section class="intro">
   <br>
        ...
        <!-- <p>Browse through the latest available properties listed on our portal.</p> -->
    </section>
  ...
  <section class="properties-listings">
    ...
    &nbsp;  &nbsp;  &nbsp; <a href="/login/login.php"> <button class="styled-button">See All Properties</button></a>
    <br>
    <br>
    <style>
        .styled-button {
