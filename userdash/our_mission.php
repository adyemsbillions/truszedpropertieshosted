      ...
      <div class="container">
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-9 text-center mt-5">
            <h1 class="heading" data-aos="fade-up">Our Mission</h1>
    ...
    <div class="section">
      <div class="container">
        <div class="row text-left mb-5">
          <div class="col-12">
            <!-- <h2 class="font-weight-bold heading text-primary mb-4">Our Mission</h2> -->
          </div>
          <div class="col-lg-6">
            ...
            <p class="text-black-50">
             <h2>Our Mission</h2>
             <p> Deliver innovative solutions, unparalleled customer service, and unmatched value to our clients. We strive to build long-lasting relationships, foster growth, and contribute to the success of our customers. We aim to connect individuals to comfortable and excellent living conditions at considerable rates and provide high-yield investment outcomes.</p>
             </p>
            <!-- <p class="text-black-50">
              <h2>OUR MISSION</h2>
