...
<section class="properties-listings">
    <center><h1>Explore More Properties</h1></center>
    ...
    if ($result && $result->num_rows > 0) {
        ...
        echo "<p>No properties found for the selected state.</p>";  // Message when no properties are found
    }
...
<button class="styled-button" onclick="window.location.href='dashboard.php'">Back to dashboard</button>
