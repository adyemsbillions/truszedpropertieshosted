        ...
        if ($stmt->num_rows > 0) {
            ...
            if ($stmt->execute()) {
                ...
                try {
                    ...
                    $mail->Password = 'hqza ymnv moav dezt'; // Replace with new App Password
                    ...
                    $mail->Body = "
                        ...
                        <head>
                            <style>
                                ...
                                h1 { color: #333; }
                                .highlight { color: goldenrod; font-weight: bold; }
                                .content { padding: 20px; background-color: #f9f9f9; border-radius: 8px; border: 1px solid #e0e0e0; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); width: 90%; max-width: 600px; margin: 20px auto; }
                                .activation-button { display: inline-block; background-color: goldenrod; color: white; font-size: 18px; text-decoration: none; padding: 15px 30px; border-radius: 5px; text-align: center; width: 100%; max-width: 250px; margin: 15px 0; font-weight: bold; }
                                .activation-button:hover { background-color: darkgoldenrod; }
                    ...
                    error_log("SMTP Error: {$mail->ErrorInfo}", 3, "email_errors.log");
                }
            } else {
    ...
    <div class="container flex">
        <div class="facebook-page flex">
            ...
            <form action="register.php" method="POST">
                ...
                <?php if ($error): ?>
                <div style="color: red; font-weight: bold; margin-bottom: 15px;"><?= htmlspecialchars($error) ?></div>
                <?php endif; ?>
